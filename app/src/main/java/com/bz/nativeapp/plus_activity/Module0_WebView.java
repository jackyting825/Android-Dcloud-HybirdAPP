 ...
 */
public class Module0_WebView extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mEntryProxy == null) {
            ...
            // 创建5+内核运行事件监听
            WebviewModule0Listener wm = new WebviewModule0Listener(this, rootView);
            // 初始化5+内核
...
class WebviewModule0Listener implements ICoreStatusListener {
    ...
    public WebviewModule0Listener(Activity activity, ViewGroup rootView) {
    ...
    public void onCoreInitEnd(ICore coreHandler) {
        ...
        String url = "file:///android_asset/apps/5plus/www/modules/index.html";
    ...
    private void regNewApi() {
        // 扩展插件在js层的标识
        String featureName = "moduleZeroPlug";
        // 扩展插件的原生类名
        String className = "com.bz.nativeapp.plus_plugins.Module0Plugin";
        // / 扩展插件的JS层封装的方法
