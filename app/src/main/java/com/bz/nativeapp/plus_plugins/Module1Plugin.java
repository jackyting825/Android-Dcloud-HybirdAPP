 ...
 **/
public class Module1Plugin extends StandardFeature {
    ...
    public String PluginTestFunctionSyncArrayArgu(IWebview pWebview, JSONArray array) {
        ...
        try {
            ...
            retJSONObj.putOpt("a", 'A');
            retJSONObj.putOpt("b", 'B');
            retJSONObj.putOpt("c", 'C');
            retJSONObj.putOpt("d", 'D');
